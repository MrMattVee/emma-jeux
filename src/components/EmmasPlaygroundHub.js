...
const games = [
  ...
  { id: 'objects', name: 'Jeu des Objets', icon: '🧸' },
  { id: 'patterns', name: 'Jeu des Suites', icon: '🔢' },
  { id: 'planificateur', name: 'Planificateur', icon: '📅' },
  { id: 'shapeSandbox', name: 'Bac à Sable de Formes', icon: '🏖️' },
];
